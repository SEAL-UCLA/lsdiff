...
public class LSDConst {
	...
	public static LSDFact createModifiedField(String fullFieldName) { 
		...
		String constants = LSDPredicate.combineArguments(fullFieldName,
				shortFieldName, containerType);
	...
	public static LSDFact createModifiedMethod(String fullMethodName) { 
		...
		String constants = LSDPredicate.combineArguments(stripDoubleQuote(fullMethodName),
				shortMethodName, containerType);
		LSDFact mf = LSDFact.createLSDFact(pred, constants, true);
		return mf;
	...
	public static LSDFact createModifiedType(String fullTypeName) { 
		...
		String constants = LSDPredicate.combineArguments(stripDoubleQuote(fullTypeName), shortTypeName, containerPackage); 
	...
	public static LSDFact createModifiedPackage(String fullPackageName) { 
		...
		String constants = "\""+fullPackageName+"\"";
